...
def query_log_analytics(log_analytics_client, workspace_id, timerange_hours, table_name, device_name, fields, caller, user_principal_name, limit=200):
...
| take {limit}'''
    ...
    if len(response.tables[0].rows) == 0:
        ...
        return { "records": "", "count": 0,  "user_query": "" }
    ...
    return { "records": records, "count": record_count,  "user_query": user_query }
